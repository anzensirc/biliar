...
import { mejaColumns } from "@/components/parts/admin/kelola-meja/column";
...
export default function MejaManajemenPage() {
  ...
  //
  const { data } = useGetMeja(queryString);
  ...
  return (
    <div className="p-4">
      ...
      <DataTable
        columns={mejaColumns(data?.data?.page ?? 1, Number(limit) ?? 10)}
        data={result}
